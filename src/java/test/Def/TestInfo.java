...
public class TestInfo {
    ...
    public static final InfoAniTorUpsert infoTorUpsert = new InfoAniTorUpsert(TEST_ANI_ID, TEST_TOR_URL);
    public static final InfoAniTorFetch  infoTorFetch  = new InfoAniTorFetch(TEST_ANI_ID, TEST_TOR_URL);
    public static final InfoAniTorStore  infoTorStore  = new InfoAniTorStore(TEST_ANI_ID, TEST_TOR_URL);
