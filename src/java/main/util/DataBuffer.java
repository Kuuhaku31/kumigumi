...
public class DataBuffer {
    ...
    public void printExcelInfo() {
        for (var tableFetch : table_fetch)
            System.out.println(tableFetch.toString());
        for (var tableDt : table_dt)
            System.out.println(tableDt.toString());
    }
}
