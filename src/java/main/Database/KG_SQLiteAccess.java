...
public class KG_SQLiteAccess {
     ...
     * -----------------------------------------------------------------------
     */
    public static void Upsert(TableName table, Map<String, String> record) throws SQLException {
        checkOpen();
     ...
     * -----------------------------------------------------------------------
     */
    public static void Upsert(TableName table, TableData data) throws SQLException, UpsertException {
        checkOpen();
        ...
        for (var h : meta.headers)
            if (incoming.contains(h.toString()))
                cols.add(h);
    ...
    private static SQLParts buildSQL(
            TableName table,
    ...
    private static String joinCols(List<DBStructure.Headers> cols) {
        return String.join(", ",
    ...
    public enum TableName {
        ...
        public static TableName Get(String value) {
            try {
    ...
    private record TableMeta(DBStructure.Headers[] primaryKeys, DBStructure.Headers[] headers) {
    }
